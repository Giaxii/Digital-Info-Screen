...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderCountryDetails(country) {
    ...
    if (state.activeContinent === "europe") {
      ...
      infoBanner.innerHTML = `
        <div class="erasmus-banner-inner">
          <svg viewBox="0 0 24 24" class="info-icon" style="width:20px; height:20px; fill:#2563eb; flex-shrink:0; margin-top:2px;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
          <p style="font-size: 11px; line-height: 1.5; margin: 0; color: #333333;">
    ...
    country.universities.forEach((uni, index) => {
      ...
      cardEl.innerHTML = `
        <div class="uni-header-pill">${uni.name}</div>
